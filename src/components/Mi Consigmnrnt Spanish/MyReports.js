...
async  handleDeleteSales(id) {
    ...
    await fetch("https://powerful-oasis-74577.herokuapp.com/api/DeleteReport", {
      method: "DELETE",
      headers: {
  ...
  async fetchData() {
    ...
    const response = await fetch("https://powerful-oasis-74577.herokuapp.com/api/getReports",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json"

...
export default class MyListingReports extends Component {
  constructor(props) {
    super(props)
    this.state = {
      searching: false,
  ...
  listingDelete(Lid ,i) {
    ...
    fetch("https://secret-lake-27653.herokuapp.com/api/DeleteAllListings",
      {
        method: "DELETE",
        headers: {
 ...
 async SetStatuss(i){
    ...
    await fetch("https://secret-lake-27653.herokuapp.com/api/UpdateReportStatus", {
      method: "PUT",
      headers: {
  ...
  async handleDeleteUser(uid, Lid ,i) {
    ...
    fetch("https://secret-lake-27653.herokuapp.com/api/deleteListingsUser",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
  ...
  async fetchData() {
    ...
    const response = await fetch("https://secret-lake-27653.herokuapp.com/api/getListReports",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json"
  ...
  async handleDelete(e, id) {
    ...
    await fetch("https://secret-lake-27653.herokuapp.com/api/DeleteReportListing", {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  async DeletReport(e, i) {
    ...
    await fetch("https://secret-lake-27653.herokuapp.com/api/DeleteListingReport", {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  async  handleSearch(e) {
    ...
    if (this.state.searchVal) {
      ...
      await fetch("https://secret-lake-27653.herokuapp.com/api/searchReport", {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"

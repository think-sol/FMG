...
async fetchData() {
    ...
    const response = await fetch("https://secret-lake-27653.herokuapp.com/api/getListings" + pageNumber,
      {
        method: "POST",
        headers: {
...
async handleDelete(e, i) {
    ...
    await fetch("https://secret-lake-27653.herokuapp.com/api/deleteListing", {
      method: "DELETE",
      headers: {
 ...
 async  handleSearch(e) {
    ...
    if(this.state.searchVal){
      ...
      await fetch("https://secret-lake-27653.herokuapp.com/api/searchListing", {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"

...
export default class MySales extends Component {
  ...
  handleDeleteSales(e) {
    ...
    fetch("https://secret-lake-27653.herokuapp.com/api/deletOrder",
      {
        method: "DELETE",
        headers: {
  ...
  async fetchData() {
    const response = await fetch("https://secret-lake-27653.herokuapp.com/api/getOrders",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"

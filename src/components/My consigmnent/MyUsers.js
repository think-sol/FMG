...
async  handleShippingProfile(uid){
  ...
  fetch("https://secret-lake-27653.herokuapp.com/api/getSpacShippings",
    {
      method: "POST",
      headers: {
  ...
  handleActivities(uid){
    ...
    fetch("https://secret-lake-27653.herokuapp.com/api/getActivity",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  handleStatus(e, i) {
    ...
    if (i === "Active") {
      ...
      fetch("https://secret-lake-27653.herokuapp.com/api/UserStausUpdate",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"

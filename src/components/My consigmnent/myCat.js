...
// alert warning
 ...
 arr.splice(i,1)
    ...
    fetch("https://secret-lake-27653.herokuapp.com/api/deleteSubCategory",
      {
        method: "PUT",
        headers: {
...
await fetch("https://secret-lake-27653.herokuapp.com/api/updateSubCat",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
 ...
 this.fetchData()
  ...
  async  handleSubCategory() {
    ...
    await fetch("https://secret-lake-27653.herokuapp.com/api/addSubCategory",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
 ...
 async handleEditSubmitCat() {
    ...
    await fetch("https://secret-lake-27653.herokuapp.com/api/updateCat",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
 ...
 this.fetchData()
  ...
  async fetchData() {
    const response = await fetch("https://secret-lake-27653.herokuapp.com/api/getCategories",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json"

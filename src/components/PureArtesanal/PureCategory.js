...
export default class PureCategory extends Component {
  constructor(props) {
    super(props)
    this.state = {
      col: 9,
...
// alert warning
 ...
 arr.splice(i,1)
    ...
    fetch("https://artisanbackend.herokuapp.com/api/deleteSubCategory",
      {
        method: "PUT",
        headers: {
...
await fetch("https://artisanbackend.herokuapp.com/api/updateSubCat",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
 ...
 this.fetchData()
  ...
  async  handleSubCategory() {
    ...
    await fetch("https://artisanbackend.herokuapp.com/api/addSubCategory",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
 ...
 async handleEditSubmitCat() {
    ...
    await fetch("https://artisanbackend.herokuapp.com/api/updateCat",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
 ...
 this.fetchData()
  ...
  async fetchData() {
    const response = await fetch("https://artisanbackend.herokuapp.com/api/getCategories",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json"

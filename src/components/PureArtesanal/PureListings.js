...
export default class PureListings extends Component {
  constructor(props) {
    super(props)
    this.state = {
      searching: false ,
  ...
  async fetchData() {
    ...
    const response = await fetch("https://artisanbackend.herokuapp.com/api/getListings" + pageNumber,
      {
        method: "POST",
        headers: {
  ...
  async handleDelete(e, i) {
    ...
    await fetch("https://artisanbackend.herokuapp.com/api/deleteListing", {
      method: "DELETE",
      headers: {
  ...
  async handleFetchById(e) {
    await fetch("https://artisanbackend.herokuapp.com/api/getListing" + e, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  async applyFilters() {
    ...
    const response = await fetch("https://artisanbackend.herokuapp.com/api/getListings" + this.state.pageNum,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
 ...
 async  handleSearch(e) {
    ...
    if(this.state.searchVal){
      ...
      await fetch("https://artisanbackend.herokuapp.com/api/searchListing", {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"
      ...
      <div>
          ...
          <div className="col-md-9">
            <div className="row">
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header"> <b>Listing Details </b></div>
                      ...
                      <div className="card-body">
                        <form className="card">
                          <div className="input-group">
                            <input type="search" onChange={this.handleChange.bind(this)} value={this.state.searchVal} className="form-control" placeholder="Search Listing Name" />
                 ...
                 {this.state.searching===false &&  <div className="container">
                    <div className="row">
                      <div className="col-sm-3" >
                        <Dropdown>
                          <Dropdown.Toggle variant="success" id="dropdown-basic">
                            Select by Days {this.state.days}
                          </Dropdown.Toggle>

                          <Dropdown.Menu>
                            <Dropdown.Item value="3" onClick={() => { this.handleDays("7") }}>7 Days</Dropdown.Item>
                            <Dropdown.Item value="3" onClick={() => { this.handleDays("30") }}>30 Days</Dropdown.Item>
                            <Dropdown.Item value="3" onClick={() => { this.handleDays("90") }}>90 Days</Dropdown.Item>
                            <Dropdown.Item value="3" onClick={() => { this.handleDays("180") }}>180 Days</Dropdown.Item>
                      ...
                      <div className="col-sm-3" >
                        <Dropdown>
                          <Dropdown.Toggle variant="success" id="dropdown-basic">
                            Trade {this.state.trade === true ? "Yes" : "No"}
                          </Dropdown.Toggle>

                          <Dropdown.Menu>
                            <Dropdown.Item onClick={() => { this.Trade(true) }}>Yes</Dropdown.Item>
                      ...
                      <div className="col-sm-3" >
                        <Dropdown>
                          <Dropdown.Toggle variant="success" id="dropdown-basic">
                            Shipping {this.state.shipping === true ? "Yes" : "No"}
                    </Dropdown.Toggle>
                          <Dropdown.Menu>
                            <Dropdown.Item onClick={() => { this.Shipping(true) }}>Yes</Dropdown.Item>
                      ...
                      <div className="col-sm-3" >
                        <button onClick={this.Reset.bind(this)} className="btn btn-success"> Reset</button>
                      </div>
                    </div>
                  </div>}
                          ...
                          <div key={listings._id} className="list-group-item list-group-item-action">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                ...
                                <h6 className="list-group-item-text"> Category : {listings.Category}</h6>
                                <p>Price : {listings.price} $ </p>
                                <p><button className="btn btn-primery" onClick={() => { this.handleModel(index) }} data-toggle="modal" data-target="#popUpWindow" ><i className="fa fa-read"></i>Read More  </button></p>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody style={{ "fontFamily": "monospace" }}>
            ...
            <h3 > Category :<i> {this.state.modelObj.Category}</i></h3>
            <h4 > SubCategory :<i> {this.state.modelObj.subCategory}</i></h4>

            <h5 > Shipping International : {this.state.modelObj.shippingInternational === true ? <span>Yes</span> : <span>No</span>}</h5>
            <h5 > Shipping Domestic :<i> {this.state.modelObj.shippingNational === true ? <span>Yes</span> : <span>No</span>}</i></h5>
            <p > <b> Description : </b> <i> {this.state.modelObj.description}</i></p>
          </ModalBody>
          <ModalFooter>

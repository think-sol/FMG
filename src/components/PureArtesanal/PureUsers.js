...
export default class PureUsers extends Component {
  constructor(props) {
    super(props)
    this.state = {
      pages: 0,
...
async  handleShippingProfile(uid){
  ...
  fetch("https://artisanbackend.herokuapp.com/api/getSpacShippings",
    {
      method: "POST",
      headers: {
  ...
  handleActivities(uid){
    ...
    fetch("https://artisanbackend.herokuapp.com/api/getActivity",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  async fetchData() {
    ...
    const response = await fetch("https://artisanbackend.herokuapp.com/api/getUsers" + pageNumber,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  handleStatus(e, i) {
    ...
    if (i === "Active") {
      ...
      fetch("https://artisanbackend.herokuapp.com/api/UserStausUpdate",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
  ...
  async handleDelete(e, uid) {
    ...
    fetch("https://artisanbackend.herokuapp.com/api/deleteUser",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
  ...
  async handleSearch(e) {
    ...
    if (this.state.searchVal) {
      ...
      await fetch("https://artisanbackend.herokuapp.com/api/userSearch", {
        method: "POST",
        headers: {

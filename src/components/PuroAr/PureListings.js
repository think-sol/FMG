...
export default class PureArListings extends Component {
  constructor(props) {
    super(props)
    this.state = {
      searching: false ,
  ...
  async fetchData() {
    ...
    const response = await fetch("https://polar-wildwood-42259.herokuapp.com/api/getListings" + pageNumber,
      {
        method: "POST",
        headers: {
  ...
  async handleDelete(e, i) {
    ...
    await fetch("https://polar-wildwood-42259.herokuapp.com/api/deleteListing", {
      method: "DELETE",
      headers: {
  ...
  async handleFetchById(e) {
    await fetch("https://polar-wildwood-42259.herokuapp.com/api/getListing" + e, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  async applyFilters() {
    ...
    const response = await fetch("https://polar-wildwood-42259.herokuapp.com/api/getListings" + this.state.pageNum,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
 ...
 async  handleSearch(e) {
    ...
    if(this.state.searchVal){
      ...
      await fetch("https://polar-wildwood-42259.herokuapp.com/api/searchListing", {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"

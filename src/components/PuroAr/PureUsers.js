...
async  handleShippingProfile(uid){
  ...
  async fetchData() {
    ...
    const response = await fetch("https://polar-wildwood-42259.herokuapp.com/api/getUsers" + pageNumber,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  async handleSearch(e) {
    ...
    if (this.state.searchVal) {
      ...
      await fetch("https://polar-wildwood-42259.herokuapp.com/api/userSearch", {
        method: "POST",
        headers: {

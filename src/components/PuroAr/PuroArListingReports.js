...
export default class PureArListingReports extends Component {
  constructor(props) {
    super(props)
    this.state = {
      searching: false,
  ...
  listingDelete(Lid ,i) {
    ...
    fetch("https://polar-wildwood-42259.herokuapp.com/api/DeleteAllListings",
      {
        method: "DELETE",
        headers: {
 ...
 async SetStatuss(i){
    ...
    await fetch("https://polar-wildwood-42259.herokuapp.com/api/UpdateReportStatus", {
      method: "PUT",
      headers: {
  ...
  async handleDeleteUser(uid, Lid ,i) {
    ...
    fetch("https://polar-wildwood-42259.herokuapp.com/api/deleteListingsUser",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
  ...
  async fetchData() {
    ...
    const response = await fetch("https://polar-wildwood-42259.herokuapp.com/api/getListReports",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json"
  ...
  async handleDelete(e, id) {
    ...
    await fetch("https://polar-wildwood-42259.herokuapp.com/api/DeleteReportListing", {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  async DeletReport(e, i) {
    ...
    await fetch("https://polar-wildwood-42259.herokuapp.com/api/DeleteListingReport", {
      method: "DELETE",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json"
  ...
  async  handleSearch(e) {
    ...
    if (this.state.searchVal) {
      ...
      await fetch("https://polar-wildwood-42259.herokuapp.com/api/searchReport", {
        method: "PUT",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json"
      ...
      <div>
          ...
          <div style={{ "paddingBottom": 50 }} className="col-md-9">
            <div className="row">
              <div className="col-md-12">
                <div className="card">
                  <div className="card-header"> <b> Detalles de listado de informes </b></div>
                      ...
                      <div className="card-body">
                        <form className="card">
                          <div className="input-group">
                            <input type="search" onChange={this.handleChange.bind(this)} value={this.state.searchVal} className="form-control" placeholder="Título del informe de búsqueda" />
                          ...
                          <div key={listings._id} className="list-group-item list-group-item-action">
                            <div className="row">
                              ...
                              <div className="col-md-8">
                                ...
                                <h6 className="list-group-item-text"> Nombre del vendedor : {listings.sellerName}</h6>
                                <p> Email : {listings.email} </p>
                                <p> Fecha : {(new Date(listings.createdDate)).toLocaleString()} </p>

                                <p >
                                Descripción del Listado : {listings.listingDescription}</p>
                                <p><button className="btn btn-primery" onClick={() => { this.handleModel(index) }} data-toggle="modal" data-target="#popUpWindow" ><i className="fab fa-readme"></i> Lee mas </button> </p>

                                {listings.Action === "0" ?
                                  <div>
                                    <p> <button className="btn btn-danger" onClick={() => { this.Check3(listings.sellerFirebaseUID, listings.listingID, listings._id) }}> Borrar usuario </button></p>
                                    <p> <button className="btn btn-danger" onClick={() => { this.Check1(listings.listingID, listings._id) }}> Eliminar listado </button></p>
                                  </div>
                                  : <span></span>}
                                ...
                                {listings.Action === "2" ?
                                  <div>
                                    ...
                                    <p style={{ "color": "red" }}> Usuario eliminado</p>
                                    <p style={{ "color": "red" }}> 
                                    Listado eliminado</p>
                                  </div>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody style={{ "fontFamily": "monospace" }}>
            <h2 > 
            Título :<i><b> {this.state.modelObj.title} </b> </i> </h2>
            <h3 > 
            Nombre de Saller  :<i> {this.state.modelObj.sellerName}</i></h3>
            <h4 >  Email :<i> {this.state.modelObj.email}</i></h4>
            <p > <b>Descripción : </b> <i> {this.state.modelObj.listingDescription}</i></p>
          </ModalBody>
          <ModalFooter>
          </ModalFooter>
        </Modal>
